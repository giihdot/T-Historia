    ...
    <>
      ...
      <div className="pagina-containerr">
        ...
        <div className="conteudo-principall">
          ...
          <p className="H1-c29">Como consequências da Crise de 1929, pode-se apontar: </p>
          <p className="ppC19">A falência de mais de 110 mil empresas e quatro mil bancos. (Maior causa de depressão do mundo)
          ...
          <div className="F-Row">
            <section className="F-Colunm">
              <p className="ppC19"><strong>Quebra de bancos e falências de empresas: </strong>A crise afetou o sistema bancário brasileiro, causando a falência de várias instituições financeiras
              ...
              <p className="ppC19"> <strong>Política de valorização do café e queima de estoque:  </strong>Para tentar conter os efeitos da crise e estabilizar o mercado interno, o governo brasileiro
              ...
              <p className="ppC19"> <strong>Industrialização e substituição das importações: </strong> A crise também acelerou o processo de industrialização do Brasil, já que o país passou a buscar alternativas para a dependência das exportações agrícolas.
              ...
              <p className="ppC19"> <strong>Mudanças políticas: </strong>A crise de 1929 contribuiu para o crescimento do descontentamento político e social, especialmente entre a classe média, os militares e os trabalhadores urbanos.
          ...
          <div className="F-Colunm">
            ...
            <div className="F-Colunm">
              <p className="H1-c29">4. Reformas Trabalhistas e Previdenciárias</p>
              <p className="ppC19">
