            ...
            <div>
              <section className="juntppFI3">
                ...
                <p className="ppFI2">
                  ...
                  determinado e indispensável à Itália. A juventude foi uma das
                  principais frentes de atuação do regime: escolas foram
                  adaptadas para transmitir doutrinas fascistas, e organizações
                  juvenis, como a Opera Nazionale Balilla, preparavam meninos e
                  meninas para servirem à pátria e obedecerem cegamente ao
                  Estado. No plano econômico, o fascismo adotou uma política
                  conhecida como “corporativismo”, que buscava controlar os
                  conflitos entre capital e trabalho por meio de corporações
                  supervisionadas pelo governo. Embora promovesse uma aparente
                  estabilidade, essa política beneficiava os grandes empresários
                  e limitava severamente os direitos dos trabalhadores. Greves
                  foram proibidas, sindicatos independentes foram dissolvidos e
                  o Estado passou a mediar todas as relações de trabalho de
                  forma autoritária. A política externa fascista foi marcada
                  pelo desejo de expansionismo e de transformação da Itália em
                  uma potência imperial. Em 1935, Mussolini ordenou a invasão da
                  Etiópia, promovendo uma guerra violenta contra o país
                  ...
                  Sicília em 1943, o regime fascista começou a ruir. Mussolini
                  foi destituído e preso, e a Itália mudou de lado no conflito,
                  aliando-se aos Aliados. No entanto, Hitler resgatou Mussolini
                  e o instalou como líder de um governo fantoche na chamada
                  República Social Italiana, no norte da Itália, que durou até
                  1945. Ao final da guerra, Mussolini foi capturado e executado
                  por partisans (resistência italiana), marcando o fim
                  definitivo do fascismo como regime oficial no país. Após a
                  guerra, a Itália se transformou em uma república democrática,
                  e o fascismo foi amplamente repudiado. No entanto, suas
                ...
                <p className="ppFI3">
                  ...
                  XX. Embora inicialmente Mussolini demonstrasse certo desprezo
                  pela figura de Hitler e pelo nazismo, especialmente por suas
                  ideias raciais extremas, a ascensão rápida do líder alemão e
                  seu crescente poder militar e político fizeram com que o
                  ditador italiano se aproximasse gradualmente do regime
                  ...
                  ele e Hitler formavam “o eixo em torno do qual o mundo
                  ...
                  Alemanha se tornou claramente dominante na parceria. A Itália,
                  com forças armadas mal preparadas e uma economia frágil,
                  passou a depender cada vez mais do apoio militar alemão.
                  Várias campanhas militares lideradas pela Itália, como as
                  invasões à Grécia e ao norte da África, falharam e tiveram de
                  ser socorridas pelos alemães. Além disso, sob influência de
                  Hitler, Mussolini adotou em 1938 as leis raciais fascistas,
                  que discriminavam judeus italianos, proibindo-os de exercer
                  cargos públicos, frequentar escolas e se casar com não judeus.
                  Essas medidas desagradaram até mesmo muitos italianos que viam
                  os judeus como parte integrante da sociedade há séculos, mas
                  Mussolini as implementou para fortalecer os laços com a
                  Alemanha nazista. A relação entre os dois ditadores chegou ao
                  fim em 1945, com a derrota iminente do Eixo. Mussolini foi
                  capturado por partisans italianos enquanto tentava fugir para
                  a Suíça e foi executado em 28 de abril de 1945. Poucos dias
                  depois, Hitler cometeu suicídio em seu bunker em Berlim. O fim
                  trágico de ambos marcou o colapso de seus regimes autoritários
                  e a libertação da Europa da tirania que haviam imposto por
                  mais de uma década. A parceria entre Mussolini e Hitler
                  representa um dos momentos mais sombrios da história moderna,
                  sendo um exemplo claro de como alianças baseadas no
