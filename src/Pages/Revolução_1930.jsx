    ...
    async function buscarResumo() {
      try {
        const resposta = await fetch(
          "https://pt.wikipedia.org/api/rest_v1/page/summary/Revolução_Brasileira_de_1930"
        );
      ...
      <div className="pag-contain">
        ...
        <main className="conte-princ">
          ...
          <section>
            <div className="resum">
              <p className="paragh">
                ...
                outros estados, como Rio Grande do Sul e Paraíba. A Aliança pretendia apresentar candidatos que oferecessem uma alternativa 
            ...
            <img className="imagens"
              src="https://terapiapolitica.com.br/wp-content/uploads/2020/11/rev-1930-1.jpg"
              alt="revoluc"
            />
          </section>
          ...
          <section className="resum">
            <div>
              <p className="paragh">
                ...
                Desde 1898, a presidência alternava entre candidatos de Minas Gerais e São Paulo, baseando-se na produção de leite e café. No entanto, a crise do café no final da década de 1920 
            ...
            <img
              src="https://3.bp.blogspot.com/_LpLU-AWokY0/TCJUam2UnaI/AAAAAAAAAB8/nRW6xCCSecY/s1600/revolu%C3%A7%C3%A3o+1930.jpg"
              alt="republic"
            />
          ...
          <section className="resum">
            <div>
              <p className="paragh">
               ...
               Para reduzir a tensão política, Vargas permitiu a convocação de eleições que resultaram na nova Constituição. A Constituição de 1934 foi inclusiva e trabalhista, estabelecendo o sufrágio universal, 
          ...
          <section className="inform-img">
            ...
            <img
              src="https://i.ytimg.com/vi/QyAVg2dpxw8/maxresdefault.jpg"
              alt="vargas"
            />
          </section>
        </main>
